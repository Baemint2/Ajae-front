...
const UserJoke = () => {
    ...
    const handleNextPage = () => {
        setSearchParams({ page: pageNo + 1 }); // 다음 페이지를 1 증가시킴
    };

    const handlePreviousPage = () => {
        if (pageNo > 1) {
            setSearchParams({ page: pageNo - 1 }); // 이전 페이지를 1 감소시킴
        }
    };
    ...
    return (
        <div className="user-joke">
            ...
            <div className="joke-wrap mt-5" ref={scrollContainerRef}>
